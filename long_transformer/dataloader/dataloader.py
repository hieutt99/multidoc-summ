...
class Batch(object):
    ...
    def __init__(self, data=None, device=None, is_test=False):
        ...
        if data is not None:
            ...
            pre_glob_mask = [x[3] for x in data]
            ...
            setattr(self, 'glob_mask', glob_mask.to(device))
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        if(is_test):
            return src, tgt, segs, glob_mask, clss, src_sent_labels, src_txt, tgt_txt
        else:
            return src, tgt, segs, glob_mask, clss, src_sent_labels
